...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(BrandController::class)->group(function () {
        ...
        Route::get('/brands/verify/{id}', 'verify')->name('brands.verify');
//        Route::get('/brands/langedit/{id}', 'langedit')->name('brands.langedit');
//        Route::patch('/brands/langedit/{id}', 'langupdate')->name('brands.langupdate');
    });
    ...
    // Sliders
     ...
     Route::controller(SliderController::class)->group(function () {
         ...
         Route::get('/sliders/langedit/{id}', 'langedit')->name('sliders.langedit');
         Route::patch('/sliders/langedit/{id}', 'langupdate')->name('sliders.langupdate');
     });


    Route::controller(DefaultProductController::class)->group(function (){
        Route::get('/default/product', 'admin_default_products')->name('defaults_products.admin');
        Route::get('/default/product/create', 'create')->name('defaults_products.create');
        Route::post('/default/product/store', 'store')->name('defaults_products.store');

        Route::get('/default/product/admin/{id}/edit', 'admin_product_edit')->name('defaults_products.admin.edit');
        Route::post('/default/product//update/{product}', 'update')->name('defaults_products.update');


        Route::get('/default/product/get/default/attributes', 'getDefaultAttributes')->name('defaults_products.getDefaultAttributes');
        Route::post('/default/product/add-more-choice-option', 'add_more_choice_option')->name('serller_defaults_products.add-more-choice-option');
        Route::post('/defaults/products/sku_combination', 'sku_combination')->name('serller_defaults_products.sku_combination');
        Route::get('/defaults/products/get/sku', 'getSku')->name('serller_defaults_products.getSku');
        Route::post('/default/products/add-more-choice-option', 'add_more_choice_option')->name('defaults_products.add-more-choice-option');
        Route::post('/default/products/sku_combination', 'sku_combination')->name('defaults_products.sku_combination');
        Route::get('/default/products/get/sku', 'getSku')->name('defaults_products.getSku');
    });
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/newest_product', 'updateNewestProduct')->name('products.newest_product');
        ...
        Route::post('/products/sku_combination2', 'sku_combination2')->name('products.sku_combimnation2');
        Route::post('/products/sku_combination_edit', 'sku_combination_edit')->name('products.sku_combination_edit');
        Route::post('/products/sku_combination_edit2', 'sku_combination_edit2')->name('products.sku_combination_edit2');
        Route::post('/products/add-more-choice-option', 'add_more_choice_option')->name('products.add-more-choice-option');
        Route::get('/products/get/attributes', 'getAttributes')->name('products.get.attributes');
        Route::get('/products/get/edit/attributes', 'getEditAttributes')->name('products.get.editAttributes');
        Route::get('/products/get/choice/optionsts', 'getChoiceOption')->name('products.get-choice-option');
    });
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/import' , 'import')->name('sellers.import');
        Route::post('/importpost', 'importpost')->name('sellers.importpost');
    ...
    Route::controller(LanguageController::class)->group(function () {
        ...
        Route::post('/languages/app-translations/importcsv', 'importCSVFile')->name('app-translations.importcsv');
    ...
    Route::controller(AttributeController::class)->group(function () {
        ...
        Route::get('/attributes/verify/{id}', 'verify')->name('attributes.verify');
        Route::get('/attributes/langedit/{id}', 'langedit')->name('attributes.langedit');
