...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){   
    Route::controller(WholesaleProductController::class)->group(function () {
        ...
        Route::get('/whole/admin/products/get/default/attributes', 'getDefaultAttributes')->name('whole_sale_products.getDefaultAttributes');
        Route::post('/whole/seller/products/add/more/choice/option', 'add_more_choice_option')->name('whole_seller_products.add-more-choice-option');
        Route::post('/whole/seller/products/sku_combination', 'sku_combination')->name('whole_sale_products.sku_combination');
    });
});
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    Route::controller(WholesaleProductController::class)->group(function () {
        ...
        Route::get('/whole/seller/products/get/default/attributes', 'getDefaultAttributes')->name('seller_whole_sale_products.getDefaultAttributes');
