...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/seller-benefit', 'sellerBenefitPage')->name('sellerbenefit.index');

    Route::post('/get-state-frontend', 'getStatesFrontend')->name('get-state-frontend');
    Route::post('/get-city-frontend', 'getCitiesFrontend')->name('get-city-frontend');
    Route::get('/deliveryboy-register', 'deliveryBoyRegisterPage')->name('deliveryboy.register');
    Route::post('/deliveryboy-registration', 'deliveryBoyRegistration')->name('deliveryboy.registration');


    // Route For Shipping From to
    Route::post('/get-to-state-frontend', 'getToStatesFrontend')->name('get-to-state-frontend');
    Route::post('/get-to-city-frontend', 'getToCitiesFrontend')->name('get-to-city-frontend');
    Route::post('/get-to-city-seller-frontend', 'getToCitiessellerFrontend')->name('get-to-seller-city-frontend');
    Route::post('/get-to-city-cost', 'getToCitiesWithCost')->name('get-to-city-cost');
