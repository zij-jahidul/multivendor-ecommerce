    ...
    <div class="row">
                        ...
                        <tbody>
                            @foreach($states as $key => $state)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('seller.states.edit', $state->id) }}" title="{{ translate('Edit') }}">
        ...
        <div class="col-md-5">
    		<div class="card">
    			...
    			<div class="card-body">
    				<form action="{{ route('seller.states.store') }}" method="POST">
    					@csrf
