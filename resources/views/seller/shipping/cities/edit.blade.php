      ...
      <div class="card">
          <div class="card-body p-0">
    		...
    		<!--		@foreach (\App\Models\Language::all() as $key => $language)
              ...
              <form class="p-4" action="{{ route('seller.cities.update', $city->id) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group mb-3 text-right">
                      <button type="submit" class="btn btn-primary">{{translate('Add to list')}}</button>
                  </div>
              </form>
          </div>
      </div>
