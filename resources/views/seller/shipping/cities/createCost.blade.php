            ...
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <!--		@foreach (\App\Models\Language::all() as $key => $language)
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3" href="{{ route('seller.cities.edit', ['id'=>$city->id, 'lang'=> $language->code] ) }}">
  	            ...
  	            @endforeach-->
                    ...
                    <form class="p-4" action="{{ route('seller.sellercities.update', $city->id) }}" method="POST" enctype="multipart/form-data">
{{--                        <input name="_method" type="hidden" value="PATCH">--}}
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" placeholder="{{translate('Name')}}" value="{{ $city->city_name }}" name="city_name" class="form-control" required>
                        </div>
