...
<form class="" action="{{route('seller.default.products.update')}}" method="POST" enctype="multipart/form-data"
    id="choice_form">
...
{{--                    @endforeach--}}
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="name"
                                placeholder="{{translate('Product Name')}}" value="{{translate($product->name)}}"
                                required>
                        </div>
                    </div>
                    <div class="form-group row" id="category">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control aiz-selectpicker" name="category_ids[]" id="category_id" data-live-search="true" required multiple onchange="getSellerDefaultAttribute()">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control"
                                placeholder="{{ translate('Barcode') }}" disabled>
                        </div>
                    </div>
                    @endif
    ...
    <div class="col-12">
        <div class="mar-all text-right mb-2">
            <button type="submit" name="button" value="publish"
                class="btn btn-primary">{{ translate('Add My Product') }}</button>
        </div>
    </div>
    </div>
</form>
...
update_sku();
    ...
    function add_more_customer_choice_option(i, name){
        $.ajax({
            ...
            type:"POST",
            url:'{{ route('seller.seller_defaults_products.add-more-choice-option') }}',
            data:{
               attribute_id: i
            },
