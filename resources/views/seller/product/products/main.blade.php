                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="name" placeholder="{{ translate('Product Name') }}"
                                    onchange="update_sku()" value="{{ old('name') }}" class="form-control">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="category_ids[]" id="category_id"
                                    data-live-search="true" multiple onchange="getSellerAttribute()">
                        ...
                        <div class="form-group row" id="brand">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="brand_id" id="brand_id"
                                    ...
                                    @endforeach
                                    @foreach (\App\Models\Brand::where('user_id', null)->get() as $brand)
                                        <option value="{{ $brand->id }}">{{ translate($brand->name) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="unit"
                                    placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" value="{{ old('unit') }}"
                                    class="form-control">
                                @if ($errors->has('unit'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" name="weight" step="0.01" value="0.00" placeholder="0.00"
                                    value="{{ old('weight') }}" class="form-control">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Dimension Of Each Package:') }}
                                <small>({{ translate('H*W*L') }})</small></label>
                            <div class="col-md-8">
                                <input type="text" name="dimension_hwl" placeholder="H*W*L"
                                    value="{{ old('dimension_hwl') }}" class="form-control">
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control"
                                        placeholder="{{ translate('Generate by Auto') }}" disabled>
                                </div>
                            </div>
                        @endif
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="video_link" placeholder="{{ translate('Video Link') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control aiz-selectpicker" data-live-search="true" name="country_id"
                                    id="country_id" value="{{ old('country_id') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control aiz-selectpicker" data-live-search="true"
                                    name="country_to_id" id="country_to_id" value="{{ old('country_to_id') }}">
                                    <option value="">{{ translate('Select Country') }}</option>
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->id }}">
                                            {{ $country->name }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 aiz-selectpicker" data-live-search="true"
                                    name="state_to_id" value="{{ old('state_to_id') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 aiz-selectpicker" data-live-search="true"
                                    name="city_to_id[]" id="city_to_id" multiple>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="number" id="shipping_to_cost" name="shipping_to_cost"
                                    value="{{ old('shipping_to_cost') }}" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="stock_visibility_state" value="text"
                                        value="{{ old('stock_visibility_state') }}">
                                    <span></span>
                                </label>
                            </div>
                        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        (function($) {
            ...
            $(document).on('change', '[name="city_to_id[]"]', function() {
                var city_to_id = $(this).val();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    url: "{{ route('get-to-city-cost') }}",
                    type: 'POST',
                    data: {
                        city_id: city_to_id
                    },
                    success: function(result) {
                        ...
                        $('#shipping_to_cost').val(result);
                        if (obj != '') {
                            $('[name="shipping_to_cost"]').val(response);
                            AIZ.plugins.bootstrapSelect('refresh');
                        }
                    },
...
@section('kemetro_script')
    ...
    <!-- Customer more choice Option custom js for add new form run time -->
