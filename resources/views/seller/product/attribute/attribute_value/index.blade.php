    ...
    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                            href="{{ route('seller.edit-attribute-value', ['id' => $attribute_value->id]) }}"
                                        ...
                                        <a href="#"
                                            ...
                                            data-href="{{ route('seller.destroy-attribute-value', $attribute_value->id) }}"
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('seller.store-attribute-value') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select  id="isprice" name="isprice" class="form-control" required>
