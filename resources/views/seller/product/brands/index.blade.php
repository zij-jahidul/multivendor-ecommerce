    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header row gutters-5">
                    <div class="col text-center text-md-left">
                        <h5 class="mb-md-0 h6">{{ translate('sellerbrands') }}</h5>
                    </div>
                    <div class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                       href="{{ route('seller.sellerbrands.edit', ['id' => $brand->id, 'lang' => 'en']) }}"
                                    ...
                                    <a href="#"
                                       ...
                                       data-href="{{ route('seller.sellerbrands.destroy', $brand->id) }}"
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('seller.sellerbrands.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="meta_description" rows="5" class="form-control" placeholder="{{ translate('Meta Description') }}" required></textarea>
