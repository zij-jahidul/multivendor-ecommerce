            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                         <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.sellerbrands.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.sellerbrands.index', 'seller.sellerbrands.create', 'seller.sellerbrands.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Seller Brand') }}</span>
                            </a>
                        </li>

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.sellerattributes.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.attributes.index', 'seller.attributes.create', 'seller.attributes.edit', 'seller.attributes.show', 'seller.edit-attribute-value']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Attribute') }}</span>
                            </a>
                        </li>

                        <!-- <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.colors') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.colors', 'seller.colors.edit']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Colors') }}</span>
                            </a>
                        </li> -->

                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.default.products') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.default.products', 'seller.default.products.create']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Default Products') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{route('seller.pick_up_points.index')}}"
                        ...
                        <i class="las la-money-bill aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{ translate('Seller Pickup point') }}</span>
                    </a>
                </li>
...
{{--                @canany(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers'])--}}
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            <i class="las la-file-alt aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('shipping_configuration')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
...
{{--                            @can('shipping_country_setting')--}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('seller.countries.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.countries.index','countries.edit','countries.update'])}}">
...
{{--                            @can('manage_shipping_states')--}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('seller.states.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.states.index','states.edit','states.update'])}}">
...
{{--                            @can('manage_shipping_cities')--}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('seller.cities.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.cities.index','cities.edit','cities.update'])}}">
...
{{--                            @can('manage_zones')--}}
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('seller.zones.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['seller.zones.index','zones.create','zones.edit'])}}">
