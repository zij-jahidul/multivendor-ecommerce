...
@include('frontend.kemedar.partials.topheader')
...
<!-- Top Bar -->
{{--<div class="top-navbar border-bottom border-soft-secondary z-1035" style="background-color: #fab104 !important">--}}
{{--    <div class="container">--}}
{{--        <div class="row">--}}
...
<section class="top-navbar border-bottom border-soft-secondary z-1035" style="background-color: #fab104 !important">
    <div class="container">
        <div class="row">

{{--        <div class="col-lg-6 col">--}}
{{--            <div class="brand-tabs">--}}
{{--                <a href="#"><img src="{{ static_asset('assets/img/kemedar.png') }}" alt="kemedar" class="mw-100 h-30px h-md-40px" height="40"></a>--}}
{{--                <a href="#"><img src="{{ static_asset('assets/img/kemmeta.png') }}" alt="kemedar" class="mw-100 h-30px h-md-40px" height="40"></a>--}}
{{--                <a href="#"><img src="{{ static_asset('assets/img/news.png') }}" alt="kemedar" class="mw-100 h-30px h-md-40px" height="40"></a>--}}
{{--            </div>--}}
{{--        </div>--}}
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 border-bottom shadow-sm" style="background-color: #fab104 !important">
