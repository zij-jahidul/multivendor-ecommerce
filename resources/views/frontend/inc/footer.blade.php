...
{{--                                href="{{ route('sellerbenefit.index') }}">--}}
{{--                                {{ translate('Seller Benefit page') }}--}}
{{--                            </a>--}}
{{--                        </li>--}}
...
{{--                            {{ translate('Apply Shop') }}--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--                @endif--}}
{{--                     <div class="text-center text-md-left mt-4">--}}
{{--                        <a href="{{ route('deliveryboy.register') }}" class="btn btn-primary btn-sm shadow-md">--}}
{{--                            {{ translate('Apply Delivery Boy') }}--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
@include('frontend.kemedar.partials.bottomfooter')
...
<div class="kemedar-signmodal">
    <!-- Kemedar Bottom Footer Import Start -->
@include('frontend.kemedar.partials.signupmodal')
<!-- Kemedar Bottom Footer Import End -->
</div>
<!-- Footer End -->
