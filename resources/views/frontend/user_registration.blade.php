                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="mb-2">
                                            <a href = "{{route('shops.create')}}" class="btn btn-info btn-block fw-600">{{  translate('Seller Register') }}</a>
                                        </div>

                                        <div class="mb-2">
                                            <a href = "{{route('deliveryboy.register')}}" class="btn btn-warning text-white btn-block fw-600">{{  translate('Delivery Boy Register') }}</a>
                                        </div>

                                        <div class="mb-2">
                                            <a href = "{{route('affiliate.apply')}}" class="btn btn-success text-white btn-block fw-600">{{  translate('Be an affiliate partner') }}</a>
                                        </div>
