                        ...
                        <td>
                            <button class="btn btn-info btn-sm" onclick="autoFillDeliveryBoy()">{{ translate('Copy credentials') }}</button>
                                ...
                                <div class="text-center">
                                    ...
                                    <br>  <br>  
                                    <a href="{{ route('user.registration') }}">{{ translate('Seller Register Now')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function autoFillSeller(){
            $('#email').val('safzahidul.cse@gmail.com');
            $('#password').val('12345678');
        }
        function autoFillCustomer(){
            $('#email').val('zijzahidul.cse@gmail.com');
            $('#password').val('123456789');
        }
        function autoFillDeliveryBoy(){
            $('#email').val('deliveryboy@gmail.com');
            $('#password').val('12345678');
        }
    </script>
@endsection
