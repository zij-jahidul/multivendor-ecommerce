        ...
        <div class="row align-items-center">
            ...
            @if($type != 'Seller' && auth()->user()->can('add_new_product'))
                <div class="col text-right">
                    <a href="{{ route('defaults_products.create') }}" class="btn btn-circle btn-info">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                @can('product_edit')
                                    ...
                                    @else
                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('defaults_products.admin.edit', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
                                            <i class="las la-edit"></i>
                                        </a>
                                    @endif
                                @endcan
