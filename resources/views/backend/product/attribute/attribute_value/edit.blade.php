    ...
    <div class="card">
        <div class="card-body p-0">
          ...
          <form class="p-4" action="{{ route('update-attribute-value', $attribute_value->id) }}" method="POST">
              ...
              <input type="hidden" name="attribute_id" value="{{ $attribute_value->attribute_id }}" required>
              @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select  id="isprice" name="isprice" class="form-control" required value="{{ $attribute_value->is_price }}">
                            <option value="{{$attribute_value->is_price}}">Select Price option</option>
