                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input onchange="update_newest_product(this)" value="{{ $product->id }}" type="checkbox" <?php if ($product->newest_product == 1) echo "checked"; ?> >
                        ...
                        <td class="text-right">
                            ...
                            @can('product_edit')
                                @if ($type == 'Seller')
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('products.seller.edit', ['id'=>$product->id, 'lang'=> 'en'] )}}" title="{{ translate('Edit') }}">
                                        <i class="las la-edit"></i>
                                    </a>
                                @else
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('products.admin.edit', ['id'=>$product->id, 'lang'=> 'en'] )}}" title="{{ translate('Edit') }}">
                                        <i class="las la-edit"></i>
                                    </a>
                                @endif
                            @endcan
...
@section('script')
    <script type="text/javascript">
        ...
        function update_newest_product(el){
            if(el.checked){
                var status = 1;
            }
            else{
            ...
            $.post('{{ route('products.newest_product') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
