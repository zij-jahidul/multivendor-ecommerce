...
<table class="table table-bordered aiz-table">
	...
	@foreach ($combinations as $key => $combination)
		...
		@php
			...
			$check='';
			$check=App\Models\AttributeValue::where('slug','=',$str)->where('is_price','Yes')->first();
			...
			@if(strlen($str) > 0)
				...
				<tr class="variant">
					...
					<td>
						...
						<input type="hidden" lang="en" name="price[]" value="{{ $unit_price }}"  class="form-control" required >
					</td>
					<td>
