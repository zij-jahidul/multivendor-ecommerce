                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                               <select class="form-control aiz-selectpicker" name="category_ids[]" id="category_id" onchange="get_attribute()" multiple>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                @if ($errors->has('weight'))
                                    <span class="error text-danger">{{ $errors->first('weight') }}</span>
                                @endif
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="state_id"></select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="city_id"></select>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="state_to_id"></select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="city_to_id[]" id="city_to_id" multiple></select>
            ...
            <div class="col-12">
                <div class="btn-toolbar float-right mb-3" role="toolbar" aria-label="Toolbar with button groups">
                    <div class="btn-group mr-2" role="group" aria-label="Third group">
                       <button  type="submit" value="unpublish" name="button"  class="btn btn-primary">{{ translate('Save & Unpublish') }}</button>
                    </div>
                    <div class="btn-group" role="group" aria-label="Second group">
                        <button  type="submit" value="publish"  name="button" class="btn btn-success" >{{ translate('Save & Publish') }}</button>
                    </div>
                </div>
            </div>
        </div>
