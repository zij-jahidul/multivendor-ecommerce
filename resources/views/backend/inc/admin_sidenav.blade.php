        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import','product_bulk_export','view_product_categories', 'view_all_brands','view_product_attributes','view_colors','view_product_reviews'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @can('add_new_product')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{ route('defaults_products.create') }}">
                                        <span class="aiz-side-nav-text">{{translate('Add New product')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('show_all_products')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('defaults_products.admin') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('All Products') }}</span>
                                    </a>
                                </li>
                            @endcan
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_all_seller')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sellers.import') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Import CSV') }}</span>
                                    </a>
                                </li>
                            @endcan
                ...
                @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link {{ areActiveRoutes(['website.footer', 'website.header' , 'sliders.index' , 'sliders.edit'])}}" >
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('sliders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sliders.index' , 'sliders.edit'])}}">
