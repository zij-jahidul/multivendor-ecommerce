...
//        $category->meta_title = $request->meta_title;
        ...
        $key_head = $request->meta_title;
        $lang_key_heading = preg_replace('/[^A-Za-z0-9\_]/', '', str_replace(' ', '_', strtolower($key_head)));
        $category->meta_title = $lang_key_heading;

//        $category->meta_description = $request->meta_description;

        $key_head = $request->meta_description;
        $lang_key_heading = preg_replace('/[^A-Za-z0-9\_]/', '', str_replace(' ', '_', strtolower($key_head)));
        $category->meta_description = $lang_key_heading;
