...
class SellerStateController extends Controller
{
...
//        $this->middleware(['permission:manage_shipping_states'])->only('index','edit');
    ...
    public function index(Request $request)
    {
        ...
        return view('seller.shipping.states.index', compact('states', 'sort_country', 'sort_state'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('seller.shipping.states.edit', compact('countries', 'state'));
    }
