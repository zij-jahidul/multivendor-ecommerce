...
//        $this->middleware(['permission:manage_zones'])->only('index','create','edit','destroy');
    ...
    public function index()
    {
        ...
        return view('seller.shipping.zones.index', compact('zones'));
    }
    ...
    public function create()
    {
        ...
        return view('seller.shipping.zones.create', compact('countries'));
    }
    ...
    public function edit(Zone $zone)
    {
        $countries = Country::where('status', 1)
                            ...
                            ->get();
        return view('seller.shipping.zones.edit', compact('countries', 'zone'));
    }
